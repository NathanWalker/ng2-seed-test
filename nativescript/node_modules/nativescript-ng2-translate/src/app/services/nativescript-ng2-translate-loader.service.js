...
var TNSTranslateLoader = (function () {
    function TNSTranslateLoader(prefix, suffix) {
        this._loaderParams = { prefix: 'i18n', suffix: '.json' };
        this.configure(prefix, suffix);
    }
    TNSTranslateLoader.prototype.configure = function (prefix, suffix) {
    ...
    TNSTranslateLoader.prototype.getTranslation = function (lang) {
        var _this = this;
    ...
    TNSTranslateLoader = __decorate([
        core_1.Injectable(),
        __param(0, core_1.Optional()),
        __param(1, core_1.Optional()), 
        __metadata('design:paramtypes', [String, String])
    ], TNSTranslateLoader);
    return TNSTranslateLoader;
}());
exports.TNSTranslateLoader = TNSTranslateLoader;
//# sourceMappingURL=nativescript-ng2-translate-loader.service.js.map